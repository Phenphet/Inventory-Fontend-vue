<script setup>
    ...
    const saveData = () => {
        if(stockStore.createInbound(formData)){
            Swal.fire({
                icon:'success',
    ...
    const btnEdit = (movement_id) => {
        ...
        const data = stockStore.stockDataIN.find(item => item.movement_id === movement_id)
        console.log(data)
    ...
    const editData = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                stockStore.updateDate(fromData)
                Swal.fire({
                    icon: 'success',
    ...
    const btnDelete = (movement_id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                stockStore.deleteInbound(movement_id)
                Swal.fire({
                    icon: 'success',
...
<template>
    <main>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header row">
                        <h3 class="card-title col-sm-10 pt-2">Table Inbound All </h3>
                        <div class="col-sm-2">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#add" @click="btnAdd()">Add Inbound</button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-bordered table-hover dataTable dtr-inline " role="grid">
                                        ...
                                        <tbody>
                                            <tr class="" v-for="items in stockStore.stockDataIN">
                                                ...
                                                <td class="">
                                                    ...
                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit" @click="btnEdit(items.movement_id)">
        ...
        <Modal :titleModal="statusModal === 'create' ? 'Create Inbound' : 'Update Inbound'"
